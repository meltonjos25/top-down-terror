...
function getPhase1ExerciseData() {
  return {
    ...
    'Husband Arms P1C1': [
      ...
      ['Tuesday','Block 1','Band Curl Isometric Hold',3,'30 sec/side','Green band. Curl to 90 degrees, hold still. Maximum tension.'],
      ['Tuesday','Block 1','Inverted Row Wide Grip',3,'10 reps','Table rows with hands wider than shoulder width. Full range.'],
      ['Tuesday','Block 1','Band Hammer Curl',3,'12/side','Green band. Palms face each other. Slow and controlled.'],
      ['Tuesday','Block 2','Band Tricep Overhead Ext',3,'12 reps','Green band anchored low. Both hands overhead. Extend fully.'],
      ['Tuesday','Block 2','Tricep Push-Up Hold',3,'20 sec','Lower halfway down. Hold. Elbows track back along ribs.'],
      ['Tuesday','Block 2','Bench Dip Negative',3,'6 reps','Chair dip. Take 5 seconds to lower. Press back up normally.'],
      ...
      ['Thursday','Block 1','Band Overhead Press',3,'12 reps','Blue band under feet. Press overhead. Full lockout at top.'],
      ['Thursday','Block 1','Pike Push-Up Hold',3,'20 sec','In pike position, lower halfway. Hold. Feel shoulder burn.'],
      ['Thursday','Block 1','Band Lateral Raise',3,'12/side','Green band. Single arm lateral raise. Lead with elbow.'],
      ['Thursday','Block 2','Band Reverse Fly',3,'12 reps','Green band. Hinge forward. Pull arms wide. Squeeze rear delts.'],
      ['Thursday','Block 2','Inverted Row Underhand',3,'10 reps','Table rows palms facing up. Targets biceps and upper back.'],
      ['Thursday','Block 2','Band High Row',3,'12 reps','Blue band anchored high. Pull to chin. Elbows flare wide.'],
      ...
      ['Saturday','Block 1','Band Curl to Press',3,'10 reps','Green band. Curl up then press overhead. Control down. Full chain.'],
      ['Saturday','Block 1','Typewriter Push-Up',3,'6/side','Push up, then slide to one side, then the other. Slow and controlled.'],
      ['Saturday','Block 1','Band Pull-Down',3,'12 reps','Blue band anchored high. Pull straight down to hips. Lats engaged.'],
      ['Saturday','Block 2','Push-Up with Hold',3,'8 reps','Lower down, hold at bottom 2 sec, press up. Full control.'],
      ['Saturday','Block 2','Band Tricep Pushdown',3,'15 reps','Blue band anchored high. Push down to full extension. Slow up.'],
      ['Saturday','Block 2','Inverted Row with Pause',3,'8 reps','Table row. Pause at top 2 sec. Squeeze shoulder blades.'],
